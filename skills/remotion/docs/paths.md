...
> Official: [https://www.remotion.dev/docs/paths](https://www.remotion.dev/docs/paths)
> Source MDX: [https://raw.githubusercontent.com/remotion-dev/remotion/main/packages/docs/docs/paths/index.mdx](https://raw.githubusercontent.com/remotion-dev/remotion/main/packages/docs/docs/paths/index.mdx)
> Mirrored: 2026-06-07
