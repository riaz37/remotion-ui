...
RemotionUI is the **copy-paste component layer for Remotion**. Use [Remotion](https://www.remotion.dev/docs) for framework fundamentals, rendering, Studio, Player, and APIs. Use RemotionUI when an agent needs ready-made source components for captions, charts, scenes, transitions, and composition templates.
