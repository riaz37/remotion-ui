...
scaled by progress. The ring and the number therefore agree on every frame.
A total that races ahead of the arcs is the usual tell of a chart animated in
