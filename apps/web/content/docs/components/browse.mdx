...
| 3D | `@/remotion/scenes/…` (render with `--gl=angle`) | `device-mockup-3d`, `product-turntable-3d`, `globe-points-3d` |
| Shaders | `@/remotion/primitives/…` (render with `--gl=angle`) | `dither-field-bg`, `warp-bands-bg` |
