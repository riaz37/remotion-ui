...
export const REGISTRY_ATLAS: Record<string, AtlasMeta> = {
  ...
  "waterfall-chart": { lane: "signals", drive: "data", tier: "advanced", tags: ["charts"] },
  "stacked-area-chart": { lane: "signals", drive: "data", tier: "advanced", tags: ["charts"] },
  "candlestick-chart": { lane: "signals", drive: "data", tier: "advanced", tags: ["charts"] },
  "gantt-timeline": { lane: "signals", drive: "data", tier: "advanced", tags: ["charts"] },
  "word-pop-captions": { lane: "signals", drive: "data", tier: "core", tags: ["captions"] },
  "caption-emoji-beat": { lane: "signals", drive: "data", tier: "advanced", tags: ["captions", "social"] },
  ...
  "form-fill-sequence": { lane: "blocks", drive: "time", tier: "core", tags: ["ui"] },
  "notification-stack": { lane: "blocks", drive: "time", tier: "core", tags: ["ui"] },
  "tab-switch-panel": { lane: "blocks", drive: "time", tier: "core", tags: ["ui"] },
  "search-results-populate": { lane: "blocks", drive: "time", tier: "core", tags: ["ui"] },
  "file-tree-reveal": { lane: "blocks", drive: "time", tier: "core", tags: ["code"] },
  "kanban-move": { lane: "blocks", drive: "time", tier: "core", tags: ["ui"] },
  "commit-graph": { lane: "blocks", drive: "time", tier: "advanced", tags: ["code"] },
