...
<StrikethroughReplace from="Motion you rent" to="Motion you own" delayInFrames={10} />`,
    props: [
      ...
      { name: "replaceDelayInFrames", type: "number", default: "14", description: "Frames after the stroke lands before the new phrase starts arriving. Below the depart length the two phrases cross-fade." },
      ...
      { name: "strikeWeight", type: "number", default: "0.07", description: "Stroke thickness in em." },
      { name: "tilt", type: "number", default: "-1.2", description: "Stroke angle in degrees off level — a hand does not rule it flat." },
    ...
    note: "Both phrases share one grid cell, so the box holds the width of the longer one and a centred line never reflows on the swap. The stroke departs inside the old phrase's layer rather than switching off.",
